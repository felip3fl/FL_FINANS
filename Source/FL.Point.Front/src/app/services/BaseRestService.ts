...
export abstract class BaseRestService<T>
{
  ...
  // Define the url of the API to be called 
...
// (window as any).open(this.getEndpoint(),'_blank');
  ...
  create(endpoint:string, item: T): Observable<T> 
  {
    ...
    return this.httpClient.post<T>(this.getEndpoint(), JSON.stringify(item), this.httpOptions)
      .pipe(
        retry(this.maxRetries),
        catchError(this.handleError)
      )
  ...
  update(endpoint:string, item: T): Observable<T> 
  {
    ...
    return this.httpClient.put<T>(this.getEndpoint(), JSON.stringify(item), this.httpOptions)
      .pipe(
        retry(this.maxRetries),
        catchError(this.handleError)
      )
  ...
  delete(endpoint:string) 
  {
    ...
    return this.httpClient.delete(this.getEndpoint(), this.httpOptions)
      .pipe(
        retry(this.maxRetries),
      )
  } 
